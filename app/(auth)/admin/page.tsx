    ...
    <div className="min-h-screen bg-gradient-to-br from-chm-black to-gray-900 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full">
        ...
        {mode === 'login' ? (
          <>
            <AdminLoginForm />
            <button onClick={() => setMode('forgot')} className="w-full mt-4 text-sm text-chm-black hover:underline font-semibold">
          ...
          <>
            ...
            <button onClick={() => setMode('login')} className="w-full mt-4 text-sm text-chm-black hover:underline font-semibold">
              Back to login
            </button>
          </>
        )}
