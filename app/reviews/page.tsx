      ...
      <div className="bg-cream py-10 border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <a href="https://g.page/r/CR84fHf4AZk-EAE/review" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 border-2 border-chm-red text-chm-red px-5 py-2 text-xs font-semibold uppercase tracking-widest hover:bg-chm-red hover:text-white transition-colors">
              Review Us on Google →
            </a>
          </div>
        </div>
